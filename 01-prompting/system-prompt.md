...
Operate on: (a) Teams Channel threads in #escalations tagged P0/P1, (b) Confluence pages in the RocketShip Product workspace, (c) Jira tickets in the ROCKET project, (d) End user interview transcripts in SharePoint folder named ROCKET. Do not act outside these surfaces._
