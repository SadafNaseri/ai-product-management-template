...
- **Value proposition:** Synthesise messy P0 threads (Teams Channel + tickets) into the top 3 risk signals so the on-call PM can decide rollback / hold / ship within 5 minutes.
